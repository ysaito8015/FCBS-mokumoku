...
pbeta(0.10, a, b) # [1] 0.63527 64%
# range of p(0.05 < theta < 0.20), the prior distribution
pbeta(0.20, a, b) - pbeta(0.05, a, b) # [1] 0.6593258 66%
...
# mean of theta|{Y=0} ~ beta(a, b + n), the posterior distribution
a / (a + b + n) # [1] 0.04761905
# mode of theta ~ beta(a, b), the posterior distribution
(a + y - 1) / ((a - 1) + (b + n - 1)) # [1] 0.025
# p(theta < 0.10|Y=0), the posterior distribution
pbeta(0.10, a + y, b + n - y) # [1] 0.9260956 93%
# p(0.05 < theta < 0.20|Y=0), the posterior distribution
pbeta(0.20, a + y, b + n - y) - pbeta(0.05, a + y, b + n - y) # [1] 0.3843402 38%
